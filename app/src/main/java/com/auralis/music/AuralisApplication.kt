...
import com.auralis.music.di.koinAppModules
...
/**
 * Application class for Auralis.
 * Annotated with @HiltAndroidApp to enable Hilt dependency injection.
 */
@HiltAndroidApp
class AuralisApplication : Application(), SingletonImageLoader.Factory, androidx.work.Configuration.Provider {
    
    @javax.inject.Inject
    lateinit var workerFactory: androidx.hilt.work.HiltWorkerFactory

    @javax.inject.Inject
    lateinit var sessionManager: com.auralis.music.data.SessionManager
    ...
    override fun attachBaseContext(base: Context) {
        ...
        com.auralis.music.core.domain.player.MusicPlayer.setApplicationContext(this)
    ...
    override fun onCreate() {
        ...
        com.auralis.music.crash.CrashLoopGuard.install(this)
        ...
        com.auralis.music.telemetry.Telemetry.install(
            com.auralis.music.telemetry.LogFailureReporter()
        )
        ...
        com.auralis.music.cache.OfflineCache.init(this)
        ...
        startKoin {
            ...
            androidContext(this@AuralisApplication)
        ...
        applicationScope.launch {
            ...
            withContext(Dispatchers.Main) {
                com.auralis.music.util.AppLog.init(this@AuralisApplication, enabled)
                com.auralis.music.util.AppLog.i("AuralisApplication") { "App initialization started" }
            }
        }
        ...
        applicationScope.launch {
            try {
                val db: com.auralis.music.core.db.SuvMusicDatabase =
        ...
        applicationScope.launch {
            com.auralis.music.util.AppLog.d("AuralisApplication") { "Setting up workers" }
            setupWorkers()
        }
    ...
    private fun seedLogoVariantMirrorIfMissing() {
        ...
        val variantName = try {
            ...
            com.auralis.music.core.model.LogoVariant.DEFAULT.name
        }
        prefs.edit().putString("logo_variant", variantName).commit()
    }

    private fun setupWorkers() {
        val workRequest = androidx.work.PeriodicWorkRequestBuilder<com.auralis.music.workers.NewReleaseWorker>(
        ...
        val updateRequest = androidx.work.PeriodicWorkRequestBuilder<com.auralis.music.workers.PeriodicUpdateWorker>(
