package com.auralis.music.crash
...
class CrashReportSender : ReportSender {
    ...
    private fun writeCrashReportFile(
        ...
        file.bufferedWriter().use { writer ->
            writer.appendLine("═══════════════════════════════════════")
            writer.appendLine("  Auralis Crash Report")
    ...
    private fun buildShareIntent(fileUri: Uri): Intent {
        val text = buildString {
            appendLine("Auralis Crash Report 🐛")
        ...
        return Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(Intent.EXTRA_SUBJECT, "Auralis Crash Report")
