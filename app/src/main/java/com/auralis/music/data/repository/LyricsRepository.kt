...
import com.auralis.music.providers.lyrics.LyricsLine
import com.auralis.music.core.model.Song
import com.auralis.music.core.model.SongSource
import com.auralis.music.providers.lyrics.BetterLyricsProvider
import com.auralis.music.providers.lyrics.LyricsProvider
import com.auralis.music.simpmusic.SimpMusicLyricsProvider
import com.auralis.music.kugou.KuGouLyricsProvider
import com.auralis.music.lrclib.LrcLibLyricsProvider
import com.auralis.music.providers.lyrics.LyricsProviderType
import com.auralis.music.core.data.local.dao.LyricsDao
import com.auralis.music.core.data.local.entity.LyricsEntity
import com.auralis.music.util.LyricsUtils
...
class LyricsRepository @Inject constructor(
    ...
    private val localLyricsProvider: com.auralis.music.providers.lyrics.LocalLyricsProvider,
    ...
    private val circuitBreaker = com.auralis.music.providers.lyrics.ProviderCircuitBreaker()
    ...
    private fun parseLrcLyrics(lrcContent: String): List<LyricsLine> {
        return com.auralis.music.util.LyricsUtils.parseLyrics(lrcContent)
    }
