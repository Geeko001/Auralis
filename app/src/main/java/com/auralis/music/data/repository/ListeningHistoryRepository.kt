...
class ListeningHistoryRepository @Inject constructor(
    ...
    val sessionManager: com.auralis.music.data.SessionManager
) {
        ...
        val updated = if (existing != null) {
            ...
            ListeningHistory(
                ...
                source = when (song.source) {
                    com.auralis.music.core.model.SongSource.YOUTUBE -> "YOUTUBE"
                    com.auralis.music.core.model.SongSource.YOUTUBE_MUSIC -> "YOUTUBE"
                    com.auralis.music.core.model.SongSource.REMOTE -> "REMOTE"
                    com.auralis.music.core.model.SongSource.LOCAL -> "LOCAL"
                    com.auralis.music.core.model.SongSource.DOWNLOADED -> "DOWNLOADED"
                },
                album = song.album,
                duration = song.duration,
                localUri = song.localUri,
