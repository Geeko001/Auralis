...
import com.auralis.music.core.model.Playlist
...
import com.auralis.music.util.encodeUrl
import com.auralis.music.util.decodeHtml
import com.auralis.music.util.toHighResImage
import com.auralis.music.data.repository.remote.RemoteConstants
import com.auralis.music.core.model.AppResult
import com.auralis.music.core.model.getOrDefault
import com.auralis.music.data.error.toAppError
import com.auralis.music.telemetry.Telemetry
import com.auralis.music.cache.OfflineCache
import com.auralis.music.data.SessionManager
import com.auralis.music.core.model.AudioQuality
...
class RemoteAudioRepository @Inject constructor(
    ...
    private val apiService: com.auralis.music.data.repository.remote.RemoteAudioApiService,
    private val playlistApiService: com.auralis.music.data.repository.remote.HqAudioPlaylistApiService,
    private val sessionManager: com.auralis.music.data.SessionManager
) {
     ...
     * [com.auralis.music.core.model.AppError]. Failures are also reported to telemetry.
     *
    ...
    suspend fun searchResult(query: String): AppResult<List<Song>> = withContext(Dispatchers.IO) {
        ...
        if (isRateLimited()) {
            ...
            return@withContext if (stale != null) {
                ...
                AppResult.Failure(com.auralis.music.core.model.AppError.RateLimited("backoff"))
            }
        }
        ...
        try {
            ...
            if (rawCount > 0 && songs.isEmpty()) {
                ...
                Telemetry.report("search", "remoteaudio", com.auralis.music.core.model.AppError.Parse("$rawCount raw, 0 parsed"))
            }
            ...
            if (error is com.auralis.music.core.model.AppError.RateLimited) noteRateLimited()
     ...
     */
    suspend fun searchArtists(query: String): List<com.auralis.music.core.model.Artist> = withContext(Dispatchers.IO) {
        if (isRateLimited()) {
        ...
        try {
            ...
            response.data?.results.orEmpty().mapNotNull { dto ->
                ...
                com.auralis.music.core.model.Artist(
                    id = id,
     ...
     */
    suspend fun searchAlbums(query: String): List<com.auralis.music.core.model.Album> = withContext(Dispatchers.IO) {
        if (isRateLimited()) {
        ...
        try {
            ...
            response.data?.results?.mapNotNull { dto ->
                val id = dto.id ?: return@mapNotNull null
                com.auralis.music.core.model.Album(
                    id = id,
     ...
     */
    suspend fun searchPlaylists(query: String): List<com.auralis.music.core.model.Playlist> = withContext(Dispatchers.IO) {
        if (isRateLimited()) {
    ...
    private fun com.auralis.music.data.repository.remote.PlaylistSearchItem.toPlaylist(
        author: String
    ): Playlist? {
     ...
     */
    suspend fun getArtist(artistId: String): com.auralis.music.core.model.Artist? = withContext(Dispatchers.IO) {
        if (isRateLimited()) {
            ...
            try {
                getHomeSections().forEach { section ->
                    section.items.forEach { item ->
                        if (item is com.auralis.music.core.model.HomeItem.SongItem) pool.add(item.song)
                    }
                }
            } catch (e: Exception) {
     ...
     */
    suspend fun getHomeSections(): List<com.auralis.music.core.model.HomeSection> = withContext(Dispatchers.IO) {
        val sections = mutableListOf<com.auralis.music.core.model.HomeSection>()
        ...
        try {
            ...
            fun parseHomeItems(jsonArray: com.google.gson.JsonArray): List<com.auralis.music.core.model.HomeItem> {
                return jsonArray.mapNotNull { element ->
                    ...
                    when (type) {
                        "song" -> {
                            parseSong(obj)?.let { com.auralis.music.core.model.HomeItem.SongItem(it) }
                        }
                        "album" -> {
                            ...
                            com.auralis.music.core.model.HomeItem.AlbumItem(
                                com.auralis.music.core.model.Album(id, title.decodeHtml(), artist.decodeHtml(), image, year)
                            )
                        }
                        "playlist" -> {
                            val id = obj.get("id")?.asString?.takeIf { it.isNotBlank() } ?: return@mapNotNull null
                            ...
                            com.auralis.music.core.model.HomeItem.PlaylistItem(
                                com.auralis.music.core.model.PlaylistDisplayItem(id, title.decodeHtml(), "", "Featured", image, count)
                            )
                        }
                        "chart" -> {
                            val id = obj.get("id")?.asString?.takeIf { it.isNotBlank() } ?: return@mapNotNull null
                            ...
                            com.auralis.music.core.model.HomeItem.PlaylistItem(
                                com.auralis.music.core.model.PlaylistDisplayItem(id, title.decodeHtml(), "", "Top Charts", image, count)
                            )
                        }
                        "radio_station" -> {
                            val id = obj.get("id")?.asString?.takeIf { it.isNotBlank() } ?: return@mapNotNull null
                            ...
                            com.auralis.music.core.model.HomeItem.PlaylistItem(
                                com.auralis.music.core.model.PlaylistDisplayItem("radio_$id", title.decodeHtml(), "", "Radio", image, 0)
                            )
                        }
                        "artist" -> {
                             val id = obj.get("id")?.asString?.takeIf { it.isNotBlank() } ?: return@mapNotNull null
                            val title = obj.get("title")?.asString ?: obj.get("name")?.asString ?: ""
                            val image = obj.get("image")?.asString?.toHighResImage()
                             com.auralis.music.core.model.HomeItem.ArtistItem(
                                com.auralis.music.core.model.Artist(id, title.decodeHtml(), image)
                            )
                        }
                        else -> null
                    }
            ...
            if (json.has("new_trending")) {
                ...
                if (items.isNotEmpty()) {
                    sections.add(com.auralis.music.core.model.HomeSection("Trending Now 🔥", items))
                }
            }
            ...
            if (json.has("charts")) {
                ...
                if (items.isNotEmpty()) {
                    sections.add(com.auralis.music.core.model.HomeSection("Top Charts 📊", items))
                }
            }
            ...
            if (json.has("new_albums")) {
                ...
                if (items.isNotEmpty()) {
                    sections.add(com.auralis.music.core.model.HomeSection("New Releases 🆕", items))
                }
            }
            ...
            if (json.has("browse_discover")) {
                ...
                discoverList.forEach { element ->
                    ...
                    if (!title.isNullOrBlank() && data != null && data.size() > 0) {
                        ...
                        if (items.isNotEmpty()) {
                            sections.add(com.auralis.music.core.model.HomeSection(title.decodeHtml(), items))
                        }
                    }
                }
            }
            ...
            if (json.has("radio")) {
                ...
                if (items.isNotEmpty()) {
                    sections.add(com.auralis.music.core.model.HomeSection("Radio Stations 📻", items))
                }
            }
            ...
            if (json.has("top_playlists")) {
                ...
                if (items.isNotEmpty()) {
                    sections.add(com.auralis.music.core.model.HomeSection("Featured Playlists 🎧", items))
                }
            }
     ...
     */
    private suspend fun fetchStaticHomeSections(): List<com.auralis.music.core.model.HomeSection> = withContext(Dispatchers.IO) {
        val sections = mutableListOf<com.auralis.music.core.model.HomeSection>()
        ...
        try {
            ...
            try {
                ...
                if (chartsJson.isJsonArray && chartsJson.asJsonArray.size() > 0) {
                    val chartItems = chartsJson.asJsonArray.take(12).mapNotNull { element ->
                        ...
                        com.auralis.music.core.model.HomeItem.PlaylistItem(
                            com.auralis.music.core.model.PlaylistDisplayItem(
                                id = chartId,
                    ...
                    if (chartItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("Top Charts 📊", chartItems))
                    }
                }
            ...
            try {
                ...
                if (albumsList != null && albumsList.size() > 0) {
                    ...
                    if (albumItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("New Releases 🆕", albumItems))
                    }
                }
            ...
            try {
                ...
                if (songsList != null && songsList.size() > 0) {
                    val songItems = songsList.take(12).mapNotNull { songElement ->
                        ...
                        com.auralis.music.core.model.HomeItem.SongItem(song)
                    }
                    if (songItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("Trending Now 🔥", songItems))
                    }
                }
            ...
            try {
                ...
                if (plList != null && plList.size() > 0) {
                    ...
                    if (playlistItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("Featured Playlists 🎧", playlistItems))
                    }
                }
            ...
            try {
                ...
                if (artistResults != null && artistResults.size() > 0) {
                    ...
                    if (artistItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("Top Artists 🎤", artistItems))
                    }
                }
            ...
            try {
                ...
                if (albumArray != null && albumArray.size() > 0) {
                    ...
                    if (albumItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("Popular Albums 💿", albumItems))
                    }
                }
            ...
            try {
                ...
                if (radioList != null && radioList.size() > 0) {
                    ...
                    if (radioItems.isNotEmpty()) {
                        sections.add(com.auralis.music.core.model.HomeSection("Radio Stations 📻", radioItems))
                    }
                }
     ...
     */
    suspend fun getFeaturedPlaylists(): List<com.auralis.music.core.model.PlaylistDisplayItem> = withContext(Dispatchers.IO) {
        val playlists = mutableListOf<com.auralis.music.core.model.PlaylistDisplayItem>()
    ...
    private fun parseSongDto(dto: com.auralis.music.data.repository.remote.RemoteAudioSongDto): Song? {
        return try {
            ...
            val metadata = com.auralis.music.core.model.RemoteAudioMetadata(
                ...
                artists = dto.artists?.all?.mapNotNull { artist ->
                    ...
                    com.auralis.music.core.model.ArtistCreditInfo(
                        name = name.decodeHtml(),
    ...
    private fun parseHqAudioPlaylistSong(
        dto: com.auralis.music.data.repository.remote.HqAudioPlaylistSong,
    ...
    suspend fun searchAll(query: String): SearchResults = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            // Parse Albums
            val albums = emptyList<com.auralis.music.core.model.Album>()
...
data class SearchResults(
    ...
    val albums: List<com.auralis.music.core.model.Album> = emptyList(),
    val artists: List<com.auralis.music.core.model.Artist> = emptyList(),
