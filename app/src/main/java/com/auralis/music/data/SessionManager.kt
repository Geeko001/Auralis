package com.auralis.music.data
...
import com.auralis.music.core.model.VideoQuality
import com.auralis.music.core.model.DownloadQuality
import com.auralis.music.core.model.HapticsIntensity
import com.auralis.music.core.model.HapticsMode
import com.auralis.music.core.model.ArtworkSize
import com.auralis.music.core.model.HomeItem
import com.auralis.music.core.model.HomeSection
import com.auralis.music.core.model.HomeSectionType
import com.auralis.music.core.model.MiniPlayerStyle
import com.auralis.music.core.model.MusicSource
import com.auralis.music.core.model.Playlist
import com.auralis.music.core.model.PlaylistDisplayItem
import com.auralis.music.core.model.RecentSearchItem
import com.auralis.music.core.model.RecentlyPlayed
import com.auralis.music.core.model.Song
import com.auralis.music.core.model.SongSource
import com.auralis.music.core.model.SponsorCategory
import com.auralis.music.core.model.ThemeMode
import com.auralis.music.core.model.UpdateChannel
import com.auralis.music.core.model.LyricsAnimationType
import com.auralis.music.providers.lyrics.LyricsProviderType
import com.auralis.music.core.model.LyricsTextPosition
...
class SessionManager @Inject constructor(
    ...
    private fun com.auralis.music.core.model.PlayerStyle.migrated(): com.auralis.music.core.model.PlayerStyle =
        if (this == com.auralis.music.core.model.PlayerStyle.LIQUID_GLASS)
            com.auralis.music.core.model.PlayerStyle.YT_MUSIC else this

    suspend fun getPlayerStyle(): com.auralis.music.core.model.PlayerStyle {
        val styleName = context.dataStore.data.first()[PLAYER_STYLE_KEY]
        return styleName?.let {
            try { com.auralis.music.core.model.PlayerStyle.valueOf(it).migrated() } catch (e: Exception) { com.auralis.music.core.model.PlayerStyle.YT_MUSIC }
        } ?: com.auralis.music.core.model.PlayerStyle.YT_MUSIC
    }

    val playerStyleFlow: Flow<com.auralis.music.core.model.PlayerStyle> = context.dataStore.data.map { preferences ->
        preferences[PLAYER_STYLE_KEY]?.let {
            try { com.auralis.music.core.model.PlayerStyle.valueOf(it).migrated() } catch (e: Exception) { com.auralis.music.core.model.PlayerStyle.YT_MUSIC }
        } ?: com.auralis.music.core.model.PlayerStyle.YT_MUSIC
    }

    suspend fun setPlayerStyle(style: com.auralis.music.core.model.PlayerStyle) {
        context.dataStore.edit { preferences ->
            preferences[PLAYER_STYLE_KEY] = style.name
        }
    }

    val playerBackgroundStyleFlow: Flow<com.auralis.music.core.model.PlayerBackgroundStyle> =
        context.dataStore.data.map { preferences ->
            preferences[PLAYER_BACKGROUND_STYLE_KEY]?.let {
                try {
                    com.auralis.music.core.model.PlayerBackgroundStyle.valueOf(it)
                } catch (e: Exception) {
                    com.auralis.music.core.model.PlayerBackgroundStyle.AMBIENT
                }
            } ?: com.auralis.music.core.model.PlayerBackgroundStyle.AMBIENT
        }

    suspend fun setPlayerBackgroundStyle(style: com.auralis.music.core.model.PlayerBackgroundStyle) {
        context.dataStore.edit { preferences ->
    ...
    suspend fun getAIPromptHistory(): com.auralis.music.ai.AIPromptHistory {
        return context.dataStore.data.first()[AI_PROMPT_HISTORY_KEY]?.let {
            com.auralis.music.ai.AIPromptHistory.fromJson(it)
        } ?: com.auralis.music.ai.AIPromptHistory()
    }
    ...
    suspend fun clearAIPromptHistory() {
        context.dataStore.edit { preferences ->
            preferences[AI_PROMPT_HISTORY_KEY] = com.auralis.music.ai.AIPromptHistory().toJson()
        }
    }

    suspend fun saveSongAISettings(songId: String, settings: com.auralis.music.ai.SongAISettings) {
    ...
    suspend fun getSongAISettings(songId: String): com.auralis.music.ai.SongAISettings? {
        val key = stringPreferencesKey("${AI_SONG_SETTINGS_PREFIX}$songId")
        return context.dataStore.data.first()[key]?.let {
            com.auralis.music.ai.SongAISettings.fromJson(it)
        }
    }
    ...
    suspend fun getLogoVariant(): com.auralis.music.core.model.LogoVariant {
        val name = context.dataStore.data.first()[LOGO_VARIANT_KEY]
        return name?.let {
            try { com.auralis.music.core.model.LogoVariant.valueOf(it) }
            catch (e: Exception) { com.auralis.music.core.model.LogoVariant.DEFAULT }
        } ?: com.auralis.music.core.model.LogoVariant.DEFAULT
    }

    val logoVariantFlow: Flow<com.auralis.music.core.model.LogoVariant> = context.dataStore.data.map { preferences ->
    ...
    suspend fun setLogoVariant(variant: com.auralis.music.core.model.LogoVariant) {
        context.dataStore.edit { preferences ->
     ...
     */
    private fun applyLauncherAlias(variant: com.auralis.music.core.model.LogoVariant) {
        ...
        val targetAliasName = "$pkg." + when (variant) {
            com.auralis.music.core.model.LogoVariant.PULSE -> "LauncherPulse"
            com.auralis.music.core.model.LogoVariant.PULSE_APP_ICON -> "LauncherPulseAppIcon"
            com.auralis.music.core.model.LogoVariant.PULSE_MONO -> "LauncherPulseMono"
            com.auralis.music.core.model.LogoVariant.PULSE_LIGHT -> "LauncherPulseLight"
            com.auralis.music.core.model.LogoVariant.PULSE_TONE -> "LauncherPulseTone"
            com.auralis.music.core.model.LogoVariant.RESONANCE -> "LauncherResonance"
            com.auralis.music.core.model.LogoVariant.RESONANCE_APP_ICON -> "LauncherResonanceAppIcon"
            com.auralis.music.core.model.LogoVariant.RESONANCE_MONO -> "LauncherResonanceMono"
            com.auralis.music.core.model.LogoVariant.RESONANCE_LIGHT -> "LauncherResonanceLight"
            com.auralis.music.core.model.LogoVariant.RESONANCE_TONE -> "LauncherResonanceTone"
            com.auralis.music.core.model.LogoVariant.AETHER -> "LauncherAether"
            com.auralis.music.core.model.LogoVariant.AETHER_APP_ICON -> "LauncherAetherAppIcon"
            com.auralis.music.core.model.LogoVariant.AETHER_MONO -> "LauncherAetherMono"
            com.auralis.music.core.model.LogoVariant.AETHER_LIGHT -> "LauncherAetherLight"
            com.auralis.music.core.model.LogoVariant.AETHER_TONE -> "LauncherAetherTone"
            com.auralis.music.core.model.LogoVariant.CLASSIC -> "LauncherClassic"
        }
...
// MusicSource enum moved to :core:model — see com.auralis.music.core.model.MusicSource
