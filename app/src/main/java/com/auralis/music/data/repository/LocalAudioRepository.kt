...
class LocalAudioRepository @Inject constructor(
     ...
     */
    suspend fun getAllLocalAlbums(): List<com.auralis.music.core.model.Album> = withContext(Dispatchers.IO) {
        val albums = mutableListOf<com.auralis.music.core.model.Album>()
     ...
     */
    suspend fun getAllLocalArtists(): List<com.auralis.music.core.model.Artist> = withContext(Dispatchers.IO) {
        val artists = mutableListOf<com.auralis.music.core.model.Artist>()
     ...
     */
    suspend fun getAlbumsByArtist(artistId: Long): List<com.auralis.music.core.model.Album> = withContext(Dispatchers.IO) {
        val albums = mutableListOf<com.auralis.music.core.model.Album>()
        ...
        context.contentResolver.query(collection, ALBUM_PROJECTION, null, null, "${MediaStore.Audio.Albums.ALBUM} ASC")?.use { cursor ->
            ...
            while (cursor.moveToNext()) {
                ...
                albums.add(com.auralis.music.core.model.Album(
                    id = id.toString(),
     ...
     * Search local albums.
     */
    suspend fun searchLocalAlbums(query: String): List<com.auralis.music.core.model.Album> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun searchLocalArtists(query: String): List<com.auralis.music.core.model.Artist> = withContext(Dispatchers.IO) {
        if (query.isBlank()) return@withContext emptyList()
        val artists = mutableListOf<com.auralis.music.core.model.Artist>()
        val collection = MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI
        ...
        context.contentResolver.query(collection, ARTIST_PROJECTION, selection, selectionArgs, "${MediaStore.Audio.Artists.ARTIST} ASC")?.use { cursor ->
            ...
            while (cursor.moveToNext()) {
                val id = cursor.getLong(idColumn)
                artists.add(com.auralis.music.core.model.Artist(
                    id = id.toString(),
