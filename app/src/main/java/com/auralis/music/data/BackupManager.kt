...
import com.auralis.music.data.model.BackupData
...
class BackupManager @Inject constructor(
    ...
    /**
     * Create a complete backup of Auralis data and write it to the provided output stream.
    ...
    /**
     * Restore Auralis data from the provided input stream.
