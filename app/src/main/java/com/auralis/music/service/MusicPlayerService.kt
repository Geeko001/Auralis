...
class MusicPlayerService : MediaLibraryService() {
    ...
    @Inject
    @com.auralis.music.di.PlayerDataSource
    ...
    @Inject
    lateinit var lastFmManager: com.auralis.music.player.LastFmManager

    @Inject
    lateinit var listenTogetherManager: com.auralis.music.shareplay.ListenTogetherManager

    @Inject
    lateinit var audioARManager: com.auralis.music.player.AudioARManager

    @Inject
    lateinit var spatialAudioProcessor: com.auralis.music.player.SpatialAudioProcessor

    @Inject
    lateinit var loudnessAnalyzer: com.auralis.music.player.LoudnessAnalyzer

    @Inject
    lateinit var sleepTimerManager: com.auralis.music.player.SleepTimerManager
    ...
    private var cachedHomeSections: List<com.auralis.music.core.model.HomeSection> = emptyList()
    
    // Cache for search results so onSearch & onGetSearchResult stay consistent
    private var cachedSearchQuery: String? = null
    private var cachedSearchResults: List<com.auralis.music.core.model.Song> = emptyList()
    
    // Browse-level song cache: videoId -> Song, populated by createPlayableMediaItem
    private val cachedBrowseSongs: MutableMap<String, com.auralis.music.core.model.Song> = java.util.concurrent.ConcurrentHashMap()
    ...
    private val playlistContextCache: MutableMap<String, List<com.auralis.music.core.model.Song>> = java.util.concurrent.ConcurrentHashMap()
    ...
    override fun onCreate() {
        ...
        mediaLibrarySession = MediaLibrarySession.Builder(this, player, object : MediaLibrarySession.Callback {
            ...
            override fun onPlayerCommandRequest(
                ...
                val lt = com.auralis.music.shareplay.ListenTogetherClient.getInstance()
            ...
            override fun onGetChildren(session: MediaLibrarySession, browser: MediaSession.ControllerInfo, parentId: String, page: Int, pageSize: Int, params: LibraryParams?): com.google.common.util.concurrent.ListenableFuture<LibraryResult<ImmutableList<MediaItem>>> {
                ...
                serviceScope.launch {
                    try {
                        ...
                        when (parentId) {
                            ROOT_ID -> {
                                children.add(createBrowsableMediaItem(HOME_ID, "Home", iconResId = com.auralis.music.R.drawable.ic_music_note))
                                children.add(createBrowsableMediaItem(LIBRARY_ID, "Library", iconResId = com.auralis.music.R.drawable.ic_heart_outline))
                                children.add(createBrowsableMediaItem(ARTISTS_ID, "Artists", iconResId = com.auralis.music.R.drawable.ic_music_note, mediaType = MediaMetadata.MEDIA_TYPE_FOLDER_ARTISTS))
                                children.add(createBrowsableMediaItem(ALBUMS_ID, "Albums", iconResId = com.auralis.music.R.drawable.ic_music_note, mediaType = MediaMetadata.MEDIA_TYPE_FOLDER_ALBUMS))
                                children.add(createBrowsableMediaItem(DOWNLOADS_ID, "Downloads", iconResId = com.auralis.music.R.drawable.ic_music_note))
                                children.add(createBrowsableMediaItem(LOCAL_ID, "Local Music", iconResId = com.auralis.music.R.drawable.ic_music_note))
                            }
                            HOME_ID -> {
                            ...
                            LIBRARY_ID -> {
                                children.add(createBrowsableMediaItem(LIKED_SONGS_ID, "Liked Songs", iconResId = com.auralis.music.R.drawable.ic_heart, mediaType = MediaMetadata.MEDIA_TYPE_PLAYLIST))
                                children.add(createBrowsableMediaItem(PLAYLISTS_ID, "Your Playlists", iconResId = com.auralis.music.R.drawable.ic_music_note, mediaType = MediaMetadata.MEDIA_TYPE_FOLDER_PLAYLISTS))
                            }
                            ARTISTS_ID -> {
                                ...
                                if (parentId.startsWith("section_")) {
                                    ...
                                    if (index != null && index in cachedHomeSections.indices) {
                                        ...
                                        val sectionSongs = section.items
                                            .filterIsInstance<com.auralis.music.core.model.HomeItem.SongItem>()
                                            .map { it.song }
                                        ...
                                        section.items.forEach { homeItem ->
                                             if (homeItem is com.auralis.music.core.model.HomeItem.SongItem) {
                                                 children.add(createPlayableMediaItem(homeItem.song))
                                             } else if (homeItem is com.auralis.music.core.model.HomeItem.PlaylistItem) {
                                             ...
                                             } else if (homeItem is com.auralis.music.core.model.HomeItem.AlbumItem) {
                                    ...
                                    val playlist = if (isAutoMix) {
                                        kotlinx.coroutines.withTimeoutOrNull(8_000L) {
                                            ...
                                            com.auralis.music.core.model.Playlist(playlistId, resolveAutoMixTitle(playlistId), "YouTube Music", null, emptyList())
                                        }
                                    } else {
                    ...
                    try {
                        ...
                        if (lastState != null) {
                            ...
                            for (i in 0 until jsonArray.length()) {
                                ...
                                val song = com.auralis.music.core.model.Song(
                                    id = obj.getString("id"),
                                    ...
                                    source = try {
                                        com.auralis.music.core.model.SongSource.valueOf(obj.optString("source", "YOUTUBE"))
                                    } catch (e: Exception) {
                                        com.auralis.music.core.model.SongSource.YOUTUBE
                                    }
                                )
    ...
    private fun getCustomLayout(): List<CommandButton> {
        ...
        val likeIcon = if (isCurrentSongLiked) com.auralis.music.R.drawable.ic_heart else com.auralis.music.R.drawable.ic_heart_outline
        
        val shuffleIcon = if (isShuffleOn) {
            com.auralis.music.R.drawable.ic_shuffle_on
        } else {
            com.auralis.music.R.drawable.ic_shuffle
        }

        val repeatIcon = when (player?.repeatMode) {
            Player.REPEAT_MODE_ALL -> com.auralis.music.R.drawable.ic_repeat_all_on
            Player.REPEAT_MODE_ONE -> com.auralis.music.R.drawable.ic_repeat_one_on
            else -> com.auralis.music.R.drawable.ic_repeat 
        }
        return listOf(
            CommandButton.Builder()
                .setDisplayName(getString(com.auralis.music.R.string.notification_action_shuffle))
                .setSessionCommand(SessionCommand(COMMAND_SHUFFLE, android.os.Bundle.EMPTY))
                .setIconResId(shuffleIcon)
                .build(),
            CommandButton.Builder()
                .setDisplayName(getString(com.auralis.music.R.string.notification_action_like))
                .setSessionCommand(SessionCommand(COMMAND_LIKE, android.os.Bundle.EMPTY))
                .setIconResId(likeIcon)
                .build(),
            CommandButton.Builder()
                .setDisplayName(getString(com.auralis.music.R.string.notification_action_repeat))
            ...
            CommandButton.Builder()
                ...
                .setIconResId(com.auralis.music.R.drawable.ic_play)
                .build()
        )
    }
    ...
    private fun resolveAutoMixTitle(playlistId: String): String =
        com.auralis.music.player.AutoMix.resolveTitle(playlistId)
    ...
    private fun createPlayableMediaItem(song: com.auralis.music.core.model.Song): MediaItem {
        ...
        serviceScope.launch {
            kotlinx.coroutines.flow.combine(sleepTimerManager.isActive, sleepTimerManager.remainingTimeMs) { isActive, remaining -> Pair(isActive, remaining) }.collect { (isActive, remaining) ->
                if (isActive && remaining != null) {
                    val timeString = com.auralis.music.util.TimeUtil.formatPosition(remaining)
                    ...
                    val notification = androidx.core.app.NotificationCompat.Builder(this@MusicPlayerService, channelId)
                        .setSmallIcon(com.auralis.music.R.drawable.ic_music_note)
                        .setContentTitle("Sleep Timer Active")
                        .setContentText("Stopping audio in $timeString")
                        .setOnlyAlertOnce(true)
                        .setOngoing(true)
                        .addAction(com.auralis.music.R.drawable.ic_music_note, "Cancel", pendingCancelIntent)
                        .setColor(androidx.core.content.ContextCompat.getColor(this@MusicPlayerService, com.auralis.music.R.color.black))
                        .build()
