...
class DownloadService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START_DOWNLOAD = "com.auralis.music.START_DOWNLOAD"
        private const val ACTION_PROCESS_QUEUE = "com.auralis.music.PROCESS_QUEUE"
        private const val ACTION_CANCEL_DOWNLOAD = "com.auralis.music.CANCEL_DOWNLOAD"
            ...
            while (true) {
                ...
                try {
                    ...
                    when (downloadRepository.downloadSong(song)) {
                        ...
                        com.auralis.music.core.model.DownloadResult.SKIPPED -> {
