...
class PlaylistImportService : Service() {
    ...
    @Inject
    lateinit var spotifyImportHelper: com.auralis.music.util.SpotifyImportHelper

    @Inject
    lateinit var youTubeRepository: YouTubeRepository

    @Inject
    lateinit var libraryRepository: com.auralis.music.core.domain.repository.LibraryRepository
    ...
    companion object {
        ...
        const val ACTION_START = "com.auralis.music.action.START_IMPORT"
        const val ACTION_CANCEL = "com.auralis.music.action.CANCEL_IMPORT"
        const val EXTRA_URL = "com.auralis.music.extra.URL"
        const val EXTRA_M3U_URI = "com.auralis.music.extra.M3U_URI"
        const val EXTRA_SUV_URI = "com.auralis.music.extra.SUV_URI"
