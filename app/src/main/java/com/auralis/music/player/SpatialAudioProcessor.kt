...
class SpatialAudioProcessor @Inject constructor(
    ...
    fun applyAIState(state: com.auralis.music.ai.AudioEffectState) {
    ...
    fun getCurrentState(): com.auralis.music.ai.AudioEffectState {
        return com.auralis.music.ai.AudioEffectState(
    ...
    fun getSignalStats(): com.auralis.music.ai.SignalStats {
        return com.auralis.music.ai.SignalStats(
