            ...
            if (content != null) {
                ...
                for (block in songBlocks) {
                    ...
                    if (currentId.isNotBlank()) {
                        val source = try {
                            com.auralis.music.core.model.SongSource.valueOf(currentSourceStr)
                        } catch (e: Exception) {
                        ...
                        val song = com.auralis.music.core.model.Song(
                            ...
                            thumbnailUrl = if (source == com.auralis.music.core.model.SongSource.YOUTUBE || source == com.auralis.music.core.model.SongSource.YOUTUBE_MUSIC) {
