...
import com.auralis.music.ai.AIProvider
import com.auralis.music.ui.components.BetaBadge
import com.auralis.music.ui.screens.ai_equalizer.AIEqLogsPanel
import com.auralis.music.ui.screens.ai_equalizer.AIEqPromptHistoryDialog
import com.auralis.music.ui.screens.ai_equalizer.AIEqPromptInput
import com.auralis.music.ui.screens.ai_equalizer.AIEqResultActions
...
@Composable
fun AIResultCard(state: com.auralis.music.ai.AudioEffectState) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        shape = RoundedCornerShape(20.dp),
        colors = CardDefaults.cardColors(
...
fun PromptHistoryItem(
    entry: com.auralis.music.ai.PromptHistoryEntry,
    onClick: () -> Unit,
    onDelete: () -> Unit
) {
