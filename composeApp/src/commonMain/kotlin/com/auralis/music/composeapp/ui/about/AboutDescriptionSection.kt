...
internal fun AboutDescriptionSection() {
    ...
    AboutCard(modifier = Modifier.padding(horizontal = 16.dp)) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text(
                text = "Built with a vision to provide a seamless, high-fidelity auditory journey, Auralis bridges the gap between massive content availability and a truly personalized user experience.",
